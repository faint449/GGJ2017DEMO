...
/////// Diffuse:
                ...
                float3 diffuseColor = lerp((_MainTex_var.rgb*(1.0 - _MainTex_var.a)),_FlashColor.rgb,_FlashIntensity);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 diffColor = lerp((_MainTex_var.rgb*(1.0 - _MainTex_var.a)),_FlashColor.rgb,_FlashIntensity);
                o.Albedo = diffColor;
