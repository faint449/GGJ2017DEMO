...
////// Lighting:
////// Emissive:
                float4 node_8898 = _Time + _TimeEditor;
                float node_8226_ang = node_8898.g;
                float node_8226_spd = _Speed;
                float node_8226_cos = cos(node_8226_spd*node_8226_ang);
                float node_8226_sin = sin(node_8226_spd*node_8226_ang);
                float2 node_8226_piv = float2(0.5,0.5);
                float2 node_8226 = (mul(i.uv0-node_8226_piv,float2x2( node_8226_cos, -node_8226_sin, node_8226_sin, node_8226_cos))+node_8226_piv);
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_8226, _MainTex));
