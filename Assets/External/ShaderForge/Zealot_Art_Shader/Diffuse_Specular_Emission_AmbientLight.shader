...
/*SF_DATA;ver:1.26;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:4013,x:32666,y:32563,varname:node_4013,prsc:2|diff-7505-RGB,spec-2340-OUT,emission-6856-OUT,amdfl-528-OUT,amspl-9089-OUT;n:type:ShaderForge.SFN_Tex2d,id:7505,x:31896,y:32261,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:node_7505,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:2340,x:32341,y:32506,varname:node_2340,prsc:2|A-7505-A,B-3715-OUT;n:type:ShaderForge.SFN_Tex2d,id:5836,x:32001,y:32603,ptovrint:False,ptlb:Emission,ptin:_Emission,varname:node_5836,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:6856,x:32341,y:32662,varname:node_6856,prsc:2|A-7505-RGB,B-5836-RGB,C-9873-OUT;n:type:ShaderForge.SFN_Slider,id:3715,x:31637,y:32526,ptovrint:False,ptlb:Specular power,ptin:_Specularpower,varname:node_3715,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:10,max:10;n:type:ShaderForge.SFN_Slider,id:9873,x:31637,y:32765,ptovrint:False,ptlb:Emission power,ptin:_Emissionpower,varname:node_9873,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:10,max:10;n:type:ShaderForge.SFN_Cubemap,id:9247,x:31775,y:32872,ptovrint:False,ptlb:Diffuse IBL,ptin:_DiffuseIBL,varname:node_9247,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,pvfc:1|DIR-6837-OUT;n:type:ShaderForge.SFN_NormalVector,id:6837,x:31599,y:32872,prsc:2,pt:True;n:type:ShaderForge.SFN_Multiply,id:7186,x:32106,y:32953,varname:node_7186,prsc:2|A-9247-A,B-1544-OUT;n:type:ShaderForge.SFN_Multiply,id:528,x:32308,y:32874,varname:node_528,prsc:2|A-9247-RGB,B-7186-OUT;n:type:ShaderForge.SFN_Cubemap,id:5276,x:31775,y:33118,ptovrint:False,ptlb:Specular IBL,ptin:_SpecularIBL,varname:node_5276,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,pvfc:1|DIR-6042-OUT;n:type:ShaderForge.SFN_ViewReflectionVector,id:6042,x:31599,y:33118,varname:node_6042,prsc:2;n:type:ShaderForge.SFN_Multiply,id:9089,x:32308,y:33114,varname:node_9089,prsc:2|A-5276-RGB,B-9018-OUT;n:type:ShaderForge.SFN_Multiply,id:9018,x:32106,y:33198,varname:node_9018,prsc:2|A-5276-A,B-2178-OUT;n:type:ShaderForge.SFN_ValueProperty,id:2178,x:31924,y:33269,ptovrint:False,ptlb:Specular IBL Value,ptin:_SpecularIBLValue,varname:node_2178,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.1;n:type:ShaderForge.SFN_ValueProperty,id:1544,x:31924,y:33040,ptovrint:False,ptlb:Diffuse IBL Value,ptin:_DiffuseIBLValue,varname:node_1544,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.1;proporder:7505-5836-9873-3715-9247-1544-5276-2178;pass:END;sub:END;*/

Shader "Zealot_Art/Diffuse_Specular_Emission_AmbientLight" {
    Properties {
        _Diffuse ("Diffuse", 2D) = "white" {}
        _Emission ("Emission", 2D) = "white" {}
        _Emissionpower ("Emission power", Range(0, 10)) = 10
...
////// Emissive:
                ...
                float3 emissive = (_Diffuse_var.rgb*_Emission_var.rgb*_Emissionpower);
/// Final Color:
