...
/*SF_DATA;ver:1.26;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:0,dpts:2,wrdp:False,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:True,fgod:False,fgor:False,fgmd:0,fgcr:0,fgcg:0,fgcb:0,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:4013,x:32823,y:32774,varname:node_4013,prsc:2|emission-1655-OUT;n:type:ShaderForge.SFN_Panner,id:3188,x:31989,y:32610,varname:node_3188,prsc:2,spu:0,spv:0.1|UVIN-7163-OUT,DIST-1339-OUT;n:type:ShaderForge.SFN_TexCoord,id:6687,x:31120,y:32485,varname:node_6687,prsc:2,uv:0;n:type:ShaderForge.SFN_Time,id:8454,x:31654,y:32617,varname:node_8454,prsc:2;n:type:ShaderForge.SFN_Slider,id:5129,x:31497,y:32784,ptovrint:False,ptlb:UVSpeed,ptin:_UVSpeed,varname:node_9088,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-10,cur:1,max:10;n:type:ShaderForge.SFN_Multiply,id:1339,x:31832,y:32685,varname:node_1339,prsc:2|A-8454-T,B-5129-OUT;n:type:ShaderForge.SFN_Distance,id:4908,x:31270,y:33224,varname:node_4908,prsc:2|A-6687-UVOUT,B-7129-OUT;n:type:ShaderForge.SFN_Vector2,id:7129,x:31072,y:33267,varname:node_7129,prsc:2,v1:0.5,v2:0.5;n:type:ShaderForge.SFN_Color,id:8182,x:32033,y:32790,ptovrint:False,ptlb:EmissionColor,ptin:_EmissionColor,varname:node_8182,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.4852941,c2:0.4049696,c3:0,c4:1;n:type:ShaderForge.SFN_Multiply,id:1655,x:32575,y:32871,varname:node_1655,prsc:2|A-3760-RGB,B-7544-OUT,C-4792-OUT;n:type:ShaderForge.SFN_Tex2d,id:3760,x:32207,y:32610,ptovrint:False,ptlb:UVAnimatedTex,ptin:_UVAnimatedTex,varname:node_3760,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-3188-UVOUT;n:type:ShaderForge.SFN_ConstantLerp,id:4792,x:31539,y:33285,varname:node_4792,prsc:2,a:1,b:-1|IN-4908-OUT;n:type:ShaderForge.SFN_Multiply,id:7544,x:32207,y:32822,varname:node_7544,prsc:2|A-8182-RGB,B-3146-OUT;n:type:ShaderForge.SFN_Vector1,id:3146,x:32033,y:32938,varname:node_3146,prsc:2,v1:5;n:type:ShaderForge.SFN_Multiply,id:7163,x:31777,y:32488,varname:node_7163,prsc:2|A-6687-UVOUT,B-4792-OUT;proporder:3760-8182-5129;pass:END;sub:END;*/

Shader "Zealot_Art/Additive_DoubleSided_UVAnimated_SoftenAround_SPDistortion01" {
    Properties {
...
////// Emissive:
                ...
                float2 node_3188 = ((i.uv0*node_4792)+(node_8454.g*_UVSpeed)*float2(0,0.1));
